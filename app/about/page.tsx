    ...
    <>
      ...
      <div className="space-y-4 max-w-none text-justify">
        ...
        <div>
          ...
          <h3 className="text-lg mb-2 font-medium tracking-tight text-foreground">Main</h3>
