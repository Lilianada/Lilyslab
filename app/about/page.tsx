  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 animate-fade-in">
      <header className="mb-8">
        ...
        <p className="text-xs text-extra-green/70">Last updated: April 30, 2025</p>
      </header>
      <div className="space-y-4 max-w-none text-justify">
        <p className="text-[14px] leading-normal mb-6">Hi! I’m Lily, a digital creator, lifestyle connoisseur, design enthusiast, passionate technologist, digital gardener, and lifelong learner. I love exploring knowledge management, creative coding, frontend design, and sharing what I learn with others. This site is my digital home for projects, notes, experiments, and inspiration. <br />Welcome!</p>
        <figure className="space-y-2 mb-6">
          <img src="/about2.jpeg" alt="lilies" className="rounded-lg shadow-md" />
          <figcaption className="text-center text-sm text-muted-foreground mt-2">lilies</figcaption>
        </figure>
        <h2 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">This site</h2>
        <p className="text-[14px] leading-normal mb-6">Here’s what you can find here, and how it all fits together:</p>

        <div>

          <h3 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">Main</h3>
        ...
        <div>
          ...
          <h3 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">Digital Garden</h3>
          <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <div>
          ...
          <h3 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">Workshop</h3>
          <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <div>
          <h3 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">Playground</h3>
          <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <div>
          ...
          <h3 className="text-[16px] mb-2 font-medium tracking-tight text-foreground">Utility</h3>
          <ul className="list-disc pl-5 space-y-1 text-sm">
            <li>Colophon: Site credits and technologies used.</li>
            <li>Changelog: Recent updates and changes.</li>
          </ul>
          <p className="text-[14px] leading-normal mb-6">This site is built as a digital garden—always evolving, never truly finished.</p>
        </div>

        <Separator />

        <p className="text-sm text-muted-foreground/60 mt-8">Credit to <a href="https://nicolevanderhoeven.com/about" className="text-extra-green/80 hover:underline" target="_blank" rel="noopener noreferrer">Nicole</a> for the design and inspiration behind this page. Find me elsewhere on <a href="https://twitter.com/lilian_okeke" className="text-extra-green/60 hover:underline" target="_blank" rel="noopener noreferrer">Twitter</a>, <a href="https://github.com/lilianokeke" className="text-extra-green/60 hover:underline" target="_blank" rel="noopener noreferrer">GitHub</a>, and <a href="https://linkedin.com/in/lilianada" className="text-extra-green/60 hover:underline" target="_blank" rel="noopener noreferrer">LinkedIn</a>. Email me at <a href="mailto:lilianokeke.ca@gmail.com" className="text-extra-green/60 hover:underline">lilianokeke.ca@gmail.com</a>, especially about this site, vibe coding, lifestyle, design, productivity, and finding hidden talent. This site was designed in 2025. View my portfolio site <a href="https://lilianada.com" className="text-extra-green/60 hover:underline" target="_blank" rel="noopener noreferrer">here</a>.</p>
