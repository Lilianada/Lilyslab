        ...
        <>
          <section className="stagger-children">
            <p className="mb-4 text-sm leading-relaxed opacity-0 animate-slide-up">
              ...
              ,{" "}
              <Link href="https://designdetails.fm" className="text-primary hover:underline">
          ...
          <section>
            <h2 className="mb-4 text-xs font-medium text-muted-foreground">Work</h2>
          ...
          <section>
            <h2 className="mb-4 text-xs font-medium text-muted-foreground">Projects</h2>
            <div className="space-y-4 stagger-children">
              {isLoading ? (
                <div className="animate-pulse space-y-4">
          ...
          <section>
            <h2 className="mb-4 text-xs font-medium text-muted-foreground">Speaking</h2>
            <div className="space-y-4 stagger-children">
              {isLoading ? (
                <div className="animate-pulse space-y-4">
                  <div className="h-16 bg-muted rounded"></div>
          ...
          <section>
            <h2 className="mb-4 text-xs font-medium text-muted-foreground">Online</h2>
