...
export const metadata: Metadata = {
  ...
  title: {
    default: "Lily's Garden",
    template: "%s | Lily's Garden",
  },
  description: "Software engineer, product manager, and digital creator",
  keywords: ["design", "development", "product management", "portfolio", "Lilian Ada", "Lilyslab", "Lily's Garden", "artificial intelligence", "machine learning", "software engineer", "product manager", "digital creator"],
  authors: [{ name: "Lilian Ada", url: "https://lilianada.com" }],
  creator: "Lilian Ada",
  publisher: "Lilian Ada",
  category: "Technology",
  applicationName: "Lily's Garden",
