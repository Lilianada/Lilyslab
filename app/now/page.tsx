    ...
    <div className={`max-w-xl mx-auto ${isLoaded ? "animate-fade-in" : "opacity-0"}`}>
      ...
      <div className="space-y-8 stagger-children">
        <section className="opacity-0 animate-slide-up">
          <h2 className="text-sm font-medium mb-3">What I'm working on</h2>
        ...
        <section className="opacity-0 animate-slide-up">
          <h2 className="text-sm font-medium mb-3">What I'm learning</h2>
          <div className="space-y-3">
            <p className="text-xs text-muted-foreground">
        ...
        <section className="opacity-0 animate-slide-up">
          <h2 className="text-sm font-medium mb-3">What I'm reading</h2>
          <div className="space-y-3">
            <p className="text-xs text-muted-foreground">
              <strong>Atomic Habits</strong> by James Clear — An easy and proven way to build good habits that lasts.
            </p>
            <p className="text-xs text-muted-foreground">
              <strong>Ikigai</strong> by Francesc Miralles and Hector Garcia — The Japanese secret to a long and happy
              life.
            </p>
            <p className="text-xs text-muted-foreground">
              <strong>Feel-Good Productivity Book</strong> by Ali Abdaal — The three fundamental energizers that make us
        ...
        <section className="opacity-0 animate-slide-up">
          <h2 className="text-sm font-medium mb-3">Where I'm at</h2>
          <div className="space-y-3">
            <p className="text-xs text-muted-foreground">
        ...
        <section className="opacity-0 animate-slide-up">
          <h2 className="text-sm font-medium mb-3">What I'm excited about</h2>
          <div className="space-y-3">
            <p className="text-xs text-muted-foreground">
