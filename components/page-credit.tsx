  ...
  return (
    <>
      ...
      <p className="text-sm text-muted-foreground/60 mt-8">
        ...
        This site was designed in <ClientOnly>{new Date().getFullYear()}</ClientOnly>. View my portfolio site <a href="https://lilianada.com" className="text-extra-green hover:underline" target="_blank" rel="noopener noreferrer">here</a>.
      </p>
    </>
  )
}
