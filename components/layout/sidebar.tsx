...
const NavItem = ({
  ...
  if (external) {
    return (
      <a
        ...
        className={`flex items-center gap-3 rounded-md px-3 py-2.5 text-sm text-muted-foreground hover:bg-accent/50 hover:text-foreground transition-all duration-300 ${
  ...
  return (
    ...
    >
      <div
        className={`text-accent-foreground transition-transform duration-200 ${
    ...
    >
      <div
        className={cn(
          ...
          mobile
            ? ""
            : "sticky top-0 z-50 h-screen flex flex-col justify-between"
        )}
      >
        {!mobile && (
        ...
        <nav
          className={cn(
            ...
            mobile ? "" : "flex-1 overflow-y-auto pt-2"
          )}
        >
          ...
          <div className="space-y-1.5 mb-2">
            ...
            <NavItem
              ...
              icon={<MessageCircleCodeIcon size={16} />}
              label="Micro-blog"
              onClick={onNavClick}
              delay={900}
            />
      ...
      <style jsx global>{`
        ...
        .custom-scrollbar a,
        .custom-scrollbar .flex.items-center {
