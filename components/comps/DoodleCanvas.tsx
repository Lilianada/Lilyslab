...
export default function DoodleCanvasWithSkeleton() {
    ...
    <div className="flex flex-col items-center">
      {isLoading ? (
        <div className="w-full animate-pulse">
          {/* Loading skeleton for color palette */}
          ...
          <div className="w-[300px] h-[180px] bg-gray-100 rounded-md mb-3">
        ...
        <>
          <div className="w-full mb-3 flex flex-wrap gap-2 justify-center">
            ...
            <div className="flex space-x-1 ml-4">
              {brushSizes.map((size) => (
                <button
                  key={size}
                  className={`w-6 h-6 flex items-center justify-center rounded-full transition-transform hover:scale-110 ${
                    brushSize === size ? "bg-gray-200" : "bg-white"
          ...
          <div className="mt-2 flex justify-between w-full">
            ...
            <Link
              href="/doodle-board"
              className="text-[10px] text-codeRed hover:underline"
            >
              View Doodle Board →
            </Link>
          </div>
