...
export function ViewCounterWrapper({ className = '' }: ViewCounterProps) {
  ...
  return (
    <div 
      className={`${positionClass} flex items-center gap-1 bg-background/80 backdrop-blur-sm px-2 py-1 rounded-full border shadow-sm ${className}`}
